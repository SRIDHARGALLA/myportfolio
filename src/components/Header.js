...
const Header = () => {
    ...
    const TheamChange = () => {
        ...
        if (document.getElementById("switch-1").checked){
            ...
            document.querySelector(".brandname h2").style.color=color;
            ...
            document.querySelector(".brandname h2").style.color="";
  ...
  return (
    <div className='header'>
        ...
        <div className='headerItems'>
            ...
            <div >
                <a href='https://www.linkedin.com/in/sridhar-galla-2001'  target='_blank'> <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-linkedin" viewBox="0 0 16 16">
